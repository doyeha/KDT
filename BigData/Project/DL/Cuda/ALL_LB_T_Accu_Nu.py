...
class BinClaModel(nn.Module):
    def __init__(self):
        super().__init__()
        self.in_layer = nn.Linear(8,25)
        self.hid_layer1 = nn.Linear(25,40)
        self.hid_layer2 = nn.Linear(40,50)
        self.hid_layer3 = nn.Linear(50,25)
        self.out_layer = nn.Linear(25,1)
