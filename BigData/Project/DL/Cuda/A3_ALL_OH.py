...
axes[0].plot(range(1, len(LOSS_HISTORY[0]) + 1), LOSS_HISTORY[1][:len(LOSS_HISTORY[1])].cpu().numpy(), label='Val')  # Move to CPU
axes[0].grid()
axes[0].legend()
...
axes[1].plot(range(1, len(SCORE_HISTORY[0]) + 1), SCORE_HISTORY[1][:len(SCORE_HISTORY[1])].cpu().numpy(), label='Val')  # Move to CPU
axes[1].grid()
axes[1].legend()
