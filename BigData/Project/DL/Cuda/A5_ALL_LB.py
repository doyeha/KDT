...
axes[0].plot(range(1, len(LOSS_HISTORY[0]) + 1), np.array(LOSS_HISTORY[0]).cpu(), label='Train')
axes[0].plot(range(1, len(LOSS_HISTORY[1]) + 1), np.array(LOSS_HISTORY[1]).cpu(), label='Val')
axes[0].grid()
axes[0].legend()
...
# Plotting R2 Score
axes[1].plot(range(1, len(SCORE_HISTORY[0]) + 1), np.array(SCORE_HISTORY[0][:len(SCORE_HISTORY[0])]), label='Train')
axes[1].plot(range(1, len(SCORE_HISTORY[0]) + 1), np.array(SCORE_HISTORY[1][:len(SCORE_HISTORY[1])]).cpu(), label='Val')  # Move to CPU
axes[1].grid()
axes[1].legend()
