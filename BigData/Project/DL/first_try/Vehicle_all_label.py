...
TrainDF.drop(['Unnamed: 0','Location'], inplace=True, axis=1)
TestDF.drop(['Unnamed: 0','Location'], inplace=True, axis=1)
...
# # 자체 Train_test_split
X_train = TrainDF.iloc[:, TrainDF.columns != TrainDF.columns[3]]
y_train = TrainDF[['Arrest']]

X_test = TestDF.iloc[:, TestDF.columns != TestDF.columns[3]]
