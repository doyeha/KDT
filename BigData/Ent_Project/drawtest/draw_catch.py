...
form_class = uic.loadUiType("drawtest.ui")[0]
# QGraphicsView display QGraphicsScene
class CView(QGraphicsView,form_class):
    
    def __init__(self):
        super().__init__()       
        self.setupUi(self)
        self.scene =  self.draw_box
        self.scene.setStyleSheet("background-color: transparent;")     
        # self.setScene(self.scene)
        # self.scene.styleSheet = background: transparent
        self.items = []
