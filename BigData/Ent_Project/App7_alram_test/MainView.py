...
class MainView(QMainWindow, form_class):
    ...
    # def first_setting_info(self, helmet, reck, crush):
    #     self.helmet_set = helmet
    #     self.reck_set = reck
    #     self.crush_set = crush
    #     self.info_list = [helmet, reck, crush]
    #     print("세팅 시작할때 값이 오기는 한다.",helmet, reck, crush)
    ...
    def load_video(self):
        ...
        if self.video_file:
            ...
            self.alram = Alram(self.signal, self.Alram_red, self.helmet_alram, self.info_list)   # self.Alram_red가 붉게 반짝이는 QLabel 파트.
    ...
    def silder_change(self, length, fps, current_time):
        ...
        silder_position = (10000 / self.total_time) * current_time
